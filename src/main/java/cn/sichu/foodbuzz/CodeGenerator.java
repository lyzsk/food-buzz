    ...
    public static void main(String[] args) {
        FastAutoGenerator.create(
                ...
                builder.parent("cn.sichu") // 设置父包名
                    ...
                    .pathInfo(
                        Collections.singletonMap(OutputFile.xml, "C://users/sichu/dev/mpGenerator")); // 设置mapperXml生成路径
            }).strategyConfig(builder -> {
                builder.addInclude("address_book", "category", "dish", "dish_flavor", "employee", "order_detail", "orders",
                    "setmeal", "setmeal_dish", "shopping_cart", "user"); // 设置需要生成的表名
